...
class Departmentadd extends PureComponent {
    ...
    handleSubmit(e){
        ...
        axios.post(API_URL+'/production/department/addDepartment.php',{
                    ...
                    <div className="col-xs-12 col-sm-8 col-md-8 bg-white">
                        <div className="panel panel-default">
                            <div className="panel-heading">
                                    <h3 className="panel-title">Please Enter Department information</h3>
                                    </div>
                                        ...
                                        <div className="row">
                                            <div className="col-xs-12 col-sm-12 col-md-12">
                                                <div className="form-group">
                                                    <input type="text" name="name" id="name" className="form-control input-sm" placeholder="Department Name"/>
                                                </div>
                                            </div> 
                                        </div>
                                        <div className="row">
