...
class Departureedit extends PureComponent {
    ...
    componentDidMount(){
        ...
        if(this.props.match != undefined){
            axios.post(API_URL+'/production/department/editDepartment.php',{
    ...
    handleSubmit(e){
        ...
        axios.post(API_URL+'/production/department/updateDepartment.php',{
                                    ...
                                    <form role="form" onSubmit={this.handleSubmit}>
                                        ...
                                        <div className="row">
                                            <div className="col-xs-12 col-sm-12 col-md-12">
                                                <div className="form-group">
                                                    <input type="text" name="name" id="name" className="form-control input-sm" onChange={this.handleChange} value={this.state.user[0].name} placeholder="Department Name"/>
                                                </div>
                                            </div> 
                                        </div>
                                        <div className="row">
