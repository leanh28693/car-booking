...
class Partneredit extends PureComponent {
    ...
    componentDidMount(){
        ...
        if(this.props.match != undefined){
            axios.post(API_URL+'/production/Partner/editPartner.php',{
    ...
    handleSubmit(e){
        ...
        axios.post(API_URL+'/production/Partner/updatePartner.php',{
                                    ...
                                    <form role="form" onSubmit={this.handleSubmit}>
                                        ...
                                        <div className="row">
                                            <div className="col-xs-12 col-sm-12 col-md-12">
                                                <div className="form-group">
                                                    <input type="text" name="name" id="name" className="form-control input-sm" onChange={this.handleChange} value={this.state.user[0].name} placeholder="Partner Name"/>
                                                </div>
                                            </div> 
                                        </div>
                                        <div className="row">
